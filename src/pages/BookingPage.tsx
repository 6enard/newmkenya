  ...
  const steps = [
    {
      ...
      description: 'Fill out our booking form with your project details and preferences.',
    },
    {
      number: '02',
      title: 'Initial Consultation',
      description: 'We\'ll contact you within 24 hours to discuss your vision and requirements.',
    },
    {
      number: '03',
      title: 'Project Proposal',
      description: 'Receive a customized proposal with timeline, deliverables, and investment.',
    },
    {
      number: '04',
      title: 'Project Kickoff',
      description: 'Once approved, we begin work and keep you updated throughout the process.',
    },
  ];
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-12 sm:mb-16">
            ...
            <p className="text-lg sm:text-xl text-gray-600 max-w-3xl font-light leading-relaxed">
              Ready to bring your vision to life? Schedule a consultation with our creative team and let's discuss your project.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {steps.map((step, index) => (
              <div key={index} className="relative">
                <div className="p-8 bg-gray-50 rounded-lg border border-black/5 hover:border-black/20 transition-all duration-300">
                  <div className="text-4xl font-light text-black/20 mb-4">{step.number}</div>
        ...
        <div className="relative max-w-4xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 px-4">
            ...
            <p className="text-base sm:text-lg text-white/80 font-light max-w-2xl mx-auto leading-relaxed">
              Fill out the form below and we'll be in touch within 24 hours to confirm your consultation
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  required
                  className="w-full bg-black border-b border-white/20 focus:border-white py-3 sm:py-4 outline-none transition-colors font-light text-base min-h-[44px] cursor-pointer"
                >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <Clock className="mx-auto mb-4 text-black" size={36} strokeWidth={1.5} />
              <h3 className="text-xl font-light mb-2">Quick Response</h3>
              <p className="text-gray-600 font-light">We typically respond within 24 hours</p>
            </div>
            <div className="text-center">
              <Calendar className="mx-auto mb-4 text-black" size={36} strokeWidth={1.5} />
              <h3 className="text-xl font-light mb-2">Flexible Scheduling</h3>
              <p className="text-gray-600 font-light">We work around your availability</p>
            </div>
            <div className="text-center">
              <CheckCircle2 className="mx-auto mb-4 text-black" size={36} strokeWidth={1.5} />
              <h3 className="text-xl font-light mb-2">Commitment</h3>
              <p className="text-gray-600 font-light">Your success is our priority</p>
            </div>
          </div>
        </div>
      </div>
